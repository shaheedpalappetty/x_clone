...
import 'package:xclone_flutter/blocs/bloc/feed_bloc.dart';
import 'package:xclone_flutter/widgets/posts/post_widget.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Center(
              child: Image.asset('assets/images/xclone_logo.jpeg', height: 50)),
